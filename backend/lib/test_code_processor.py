#!/usr/bin/env python3
"""Smoke test for RepositoryProcessor."""
...
def main():
    print("=" * 60)
    print("RepositoryProcessor Smoke Test")
    print("=" * 60)
    print()
    ...
    try:
        ...
        if files:
            ...
            print("   No source files found (repository may not have supported extensions)")
        print()
        
        # Test file processing if files exist
        if files:
            test_file = files[0]
            ...
            if chunks:
                ...
                print(f"       Content: {first_chunk['content'][:60]}...")
            print()
        else:
            print("4. Skipping file processing (no files discovered)")
            print()
